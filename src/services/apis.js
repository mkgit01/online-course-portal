...
export const profileEndpoints = {
  ...
  GET_ALL_INSTRUCTOR_DASHBOARD_DETAILS_API:
    BASE_URL + "/api/v1/profile/getInstructorDashboardDetails",
};
...
export const studentEndpoints = {
  ...
  ENROLL_COURSE_API: BASE_URL + "/api/v1/course/enroll",
};
...
export const courseEndpoints = {
  ...
  ADD_COURSE_TO_CATEGORY_API: BASE_URL + "/api/v1/course/addCourseToCategory",
  SEARCH_COURSES_API: BASE_URL + "/api/v1/course/searchCourse",
